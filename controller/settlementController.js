...
const getAllSettlementDetails = async (req, res) => {
    try {
        const { limit, offset, bankName, branchName } = req.query;
        const settlementDetails = await settlementDetailsService.getAllSettlementDetails(limit, offset, bankName, branchName);
